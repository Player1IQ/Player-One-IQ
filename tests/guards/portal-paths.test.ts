...
const playerCases: PortalCase[] = [
  ...
  { role: "player", pathname: "/campaigns", expected: true },
  { role: "player", pathname: "/campaigns/1", expected: true },
  { role: "player", pathname: "/opportunities", expected: true },
  { role: "player", pathname: "/opportunities/1", expected: true },
  { role: "player", pathname: "/opportunities/applications", expected: true },
  { role: "player", pathname: "/portal/deliverables", expected: true },
  { role: "player", pathname: "/portal/coach", expected: true },
  { role: "player", pathname: "/coach", expected: true },
  ...
  { role: "player", pathname: "/account", expected: true },
  { role: "player", pathname: "/portal/account", expected: true },
  { role: "player", pathname: "/schedule", expected: true },
