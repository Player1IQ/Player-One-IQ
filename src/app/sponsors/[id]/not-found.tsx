...
export default function SponsorNotFound() {
  return (
    <DashboardLayout title="Sponsor Not Found">
      <div className="flex min-h-[400px] flex-col items-center justify-center rounded-xl border border-dashed border-border bg-surface-raised">
        <p className="text-lg font-medium text-gray-300">Sponsor not found</p>
        <p className="mt-1 text-sm text-gray-500">
          This sponsor may have been removed or the link is invalid.
        </p>
        <Link
          href="/sponsors"
